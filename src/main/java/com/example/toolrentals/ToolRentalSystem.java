package com.example.toolrentals;
    ...
    public static class OrderDetails extends Application {
        ...
        private void placeOrder(ToolRentalSystem rentalSystem) {
            ...
            RentalAgreement(customerId, customerName,
                                ...
                                dailyCharge, rentalAgreementInfo.getRentalDays(),
                                startDate, rentalAgreementInfo.getChargeDays(),
                                rentalAgreementInfo.getTotalCharge(),
                                discountPct, rentalAgreementInfo.getDiscountAmt(),
                                rentalAgreementInfo.getAfterDiscountTotal());
        ...
        public static boolean isHoliday(@NotNull LocalDate inDate){
            ...
            if (month == 7){
                if (day == 4 && (DOW != DayOfWeek.SATURDAY && DOW != DayOfWeek.SUNDAY)){
                    return true;
                } else if (day == 3 && DOW.equals(DayOfWeek.FRIDAY) ){
                    return true;
                } else if (day == 5 && DOW.equals(DayOfWeek.MONDAY)){
                    return true;
                } else {
                    return false;
                }
           ...
           if (month == 9){
                return (day <= 7) && (DOW.equals(DayOfWeek.MONDAY)); // assumes 1st Monday of September - Labor Day
            }
            return false;
        }
        ...
        private void RentalAgreement(String customerID, String customerName,
            ...
            stringLabel = new Label(checkoutDate.plusDays(rentalDays - 1).toString());
            gridPane2.add(new Label("Return Date: "), 0, 5);
            gridPane2.add(stringLabel, 1, 5);

            stringLabel = new Label(Float.toString(dailyRentalFee));
            gridPane2.add(new Label("Daily Rental Fee: "), 0, 6);
